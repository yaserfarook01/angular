...
describe('AddMovieComponent', () => {
  ...
  fit('should_create_AddMovieComponent', () => {
    expect(component).toBeTruthy();
  });

  fit('should_add_a_new_movie_when_form_is_valid', () => {
    const mockMovie = {
      title: 'Inception',
  ...
  fit('should_validate_all_required_fields', () => {
  ...
  fit('should_validate_rating_value', () => {
    const form = component.movieForm;
