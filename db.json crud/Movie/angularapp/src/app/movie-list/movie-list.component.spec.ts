...
describe('MovieListComponent', () => {  // Update describe block name
  ...
  fit('should create MovieListComponent', () => {  // Update test case name
    expect(component).toBeTruthy();
  });

  fit('should call getMovies', () => {  // Update test case name
  ...
  fit('should call deleteMovie', () => {  // Update test case name
